...
public class my_blog extends JFrame{
	public  my_blog(User U){
		JFrame my_blog=new JFrame("我的博客");
	    my_blog.setSize(980, 830);
	    my_blog.setLocationRelativeTo(null);
	    my_blog.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
	    my_blog.setResizable(false);
	    ...
	    my_blog.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
	    my_blog.addWindowListener(new WindowAdapter() {
        ...
        for (int i = 0; i < Blogs.size(); i++) {
          ...
          //读取点赞人信息
            ...
            //删除按钮
            JButton delete=new JButton("删除博客");
            blog.add(delete);
            delete.setBounds(690, 100+150*i+NumberOfReply*35, 120, 30);
            delete.addActionListener(new ActionListener() {
            	String BID;
	            public void actionPerformed(ActionEvent e) {
	            	   String Info=U.deleteBlog(BID);
	            	   if(Info.equals("删除成功！")) {
            ...
            for(int k=0;k<Blogs.get(i).getReplySize();k++) {
	            ...
	            reply_but.addActionListener(new ActionListener() {
		            ...
		            public void actionPerformed(ActionEvent e) {
		            	new Reply_GUI3(U,BID,fromUID,toUID);
		            	my_blog.dispose();
		            }
        ...
        my_blog.setContentPane(splitPane);
